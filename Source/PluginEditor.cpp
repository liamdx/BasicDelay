...
void BasicDelayAudioProcessorEditor::resized()
{
    ...
    sliderFeedback->setBounds (32, 104, 150, 24);
    sliderDelayTime->setBounds (32, 40, 150, 24);
    labelDelayTime->setBounds (32, 8, 150, 24);
    labelFeedback->setBounds (32, 72, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="BasicDelayAudioProcessorEditor"
                 ...
                 constructorParams="BasicDelayAudioProcessor&amp; p" variableInitialisers="AudioProcessorEditor(p),&#10;processor(p)"
                 snapPixels="8" snapActive="1" snapShown="1" overlayOpacity="0.330"
                 fixedSize="0" initialWidth="600" initialHeight="400">
  <BACKGROUND backgroundColour="ffffffff"/>
  <SLIDER name="feedback" id="bb7e702469c5a4a9" memberName="sliderFeedback"
          virtualName="" explicitFocusOrder="0" pos="32 104 150 24" min="0"
          max="0.94999999999999995559" int="0" style="LinearHorizontal"
          textBoxPos="TextBoxLeft" textBoxEditable="1" textBoxWidth="80"
          textBoxHeight="20" skewFactor="1" needsCallback="1"/>
  <SLIDER name="delay time" id="5fe4bce8b785a664" memberName="sliderDelayTime"
          virtualName="" explicitFocusOrder="0" pos="32 40 150 24" min="0.010000000000000000208"
          max="1" int="0" style="LinearHorizontal" textBoxPos="TextBoxLeft"
          textBoxEditable="1" textBoxWidth="80" textBoxHeight="20" skewFactor="1"
          needsCallback="1"/>
  <LABEL name="new label" id="2b9fdb31cb35c32f" memberName="labelDelayTime"
         virtualName="" explicitFocusOrder="0" pos="32 8 150 24" edTextCol="ff000000"
         edBkgCol="0" labelText="Delay Time (s)&#10;" editableSingleClick="0"
         editableDoubleClick="0" focusDiscardsChanges="0" fontname="Default font"
         fontsize="15" bold="0" italic="0" justification="33"/>
  <LABEL name="new label" id="f3b60198c0bd425f" memberName="labelFeedback"
         virtualName="" explicitFocusOrder="0" pos="32 72 150 24" edTextCol="ff000000"
